package com.example.yida.demo.quartz1.controller;

import com.example.yida.demo.quartz1.entity.QuartzBean;
import com.example.yida.demo.quartz1.util.QuartzUtils;
...
public class QuartzController1 {
    ...
    public String createJob(QuartzBean quartzBean) {
        try {
            //进行测试所以写死
            quartzBean.setJobClass("com.example.yida.demo.quartz1.task.MyTask1");
